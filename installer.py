...
def main():
    ...
    os.system("python -m pip install --quiet --no-warn-script-location accelerate==0.25.0")
    
    print("Installing [diffusers]")
    os.system("python -m pip install --quiet --no-warn-script-location diffusers==0.25.0")
    
    print("Installing [transformers]")
    os.system("python -m pip install --quiet --no-warn-script-location transformers==4.36.2")
    
    print("Installing [peft]")
    os.system("python -m pip install --quiet --no-warn-script-location peft==0.7.1")
    
    print("Installing [safetensors]")
    os.system("python -m pip install --quiet --no-warn-script-location safetensors==0.4.1")
    
    print("Installing [realesrgan]")
    os.system("python -m pip install --quiet --no-warn-script-location realesrgan==0.3.0")

    print("Installing [websockets]")
    os.system("python -m pip install --quiet --no-warn-script-location websockets==12.0")
